          ...
          <div className={styles.block7}>
            <div className={`text-center ${styles.textCenter}`}>
              ...
              <span className={styles.price}>
                <sup>Rs.</sup>{" "}
                <span className={styles.number}>{card.price}</span>
              </span>
              <span className={`${styles.excerpt} ${styles.dBlock}`}>
                For {card.duration} hrs
              </span>
              <span className={`${styles.excerpt} ${styles.dBlock}`}>
                At {card.branch} Branch
              </span>
              <h3 className={`${styles.heading2} my-4`}>6 months Validity</h3>
