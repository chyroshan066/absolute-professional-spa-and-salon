                                ...
                                return (
                                    <div key={therapy.index} className={styles.card}>
                                        ...
                                        >
                                            <h2 className="mb-0">
                                                <button
                                                    className={`d-flex align-items-center ${styles.justifyContentBetween} btn ${styles.btn} btn-link ${styles.btnLink} ${!isOpen ? 'collapsed' : ''}`}
                                        ...
                                        >
                                            ...
                                            <div className={styles.innerContent}>
                                                <div className={`${styles.cardBody} ${styles.textLeft}`}>
                                                    <ul>
